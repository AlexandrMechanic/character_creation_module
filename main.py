...
def attack(char_name: str, char_class: str) -> typing.Union[str, None]:
...
def defence(char_name: str, char_class: str) -> typing.Union[str, None]:
    """Amount of damage blocked by enemy."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> typing.Union[str, None]:
    """Amount of special skill added."""
    if char_class == 'warrior':
